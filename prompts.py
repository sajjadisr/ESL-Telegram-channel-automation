...
- توی جمله‌های انگلیسی همیشه از علائم نگارشی خودِ انگلیسی استفاده کن (کامای انگلیسی «,» نه ویرگول فارسی «،»؛ نقطه‌ی انگلیسی «.» نه نقطه‌ی فارسی «۔»؛ علامت سوال انگلیسی «?» نه فارسی «؟»). این یه اشتباه تایپیِ تکرارشونده‌ست — قبل از فرستادن پاسخ، خودت جمله‌های انگلیسی رو یه بار مرور کن و مطمئن شو هیچ کاراکتر فارسی داخلشون نیست.
