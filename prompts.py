...
FORMATS = {
    "micro_scene": {
        ...
        "use_tiers": True,
        "guidance": (
            "یه صحنه‌ی کوتاه و واقعی بساز (۲ تا ۴ خط دیالوگ یا روایت) که توش موضوع امروز به‌طور طبیعی "
            "پیش بیاد — نه یه جمله‌ی نمونه‌ی خشک. صحنه باید یه قلاب واقعی داشته باشه: شوخی، غافلگیری، یا "
            "یه لحظه‌ی قابل‌ارتباط. اگه فقط داری کاربرد درست جمله رو نشون می‌دی، این میکرو-صحنه نیست، یه "
            "مثال گرامری با لباس مبدله — دوباره بنویسش."
        ),
    },
    "illustrated_pun": {
        "label": "شوخی تصویری",
    ...
    "story_installment": {
        ...
        "use_tiers": False,
        "guidance": (
            "این قسمت بعدیِ داستان دنباله‌داره، با همون دو شخصیت ثابت (مشخصاتشون پایین اومده). یه موقعیت "
            "کوتاه و قابل‌ارتباط بساز که توش موضوع امروز به‌طور طبیعی پیش بیاد. آخرش رو با یه کنجکاوی کوچیک "
            "برای قسمت بعد تموم کن."
        ),
    },
    "spot_mistake": {
...
PERSIAN_REGISTER = """فارسیِ خودمونی و گفتاری بنویس (محاوره‌ای)، نه فارسیِ کتابی یا ترجمه‌شده:
